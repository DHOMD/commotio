...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=mantaray BUILD_FINGERPRINT=google/mantaray/manta:4.4.4/KTU84P/937116:user/release-keys PRIVATE_BUILD_DESC="mantaray-user 4.4.4 KTU84P 937116 release-keys"
PRODUCT_PROPERTY_OVERRIDES += \
