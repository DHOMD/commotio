...
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_FINGERPRINT=5.0/LRX21M/1426582430:user/release-keys PRIVATE_BUILD_DESC="msm8974-user 5.0 LRX21M 193 release-keys" TARGET_DEVICE="FIND7"
