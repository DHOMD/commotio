...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=jfltecri TARGET_DEVICE=jfltecri BUILD_FINGERPRINT="samsung/jfltecri/jfltecri:4.4.1/KOT49E/R970CVVUAME4:user/release-keys" PRIVATE_BUILD_DESC="jfltecri-user 4.4.1 KOT49E R970CVVUAME4 release-keys"
