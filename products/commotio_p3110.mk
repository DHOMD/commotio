...
PRODUCT_NAME := commotio_p3110
PRODUCT_DEVICE := p3110
PRODUCT_BRAND := Samsung
PRODUCT_MANUFACTURER := Samsung
PRODUCT_MODEL := GT-P3110

PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=espressowifixx TARGET_DEVICE=espressowifi BUILD_FINGERPRINT=samsung/espressowifixx/espressowifi:4.4.2/KOT49H/P3110XWALD2:user/release-keys PRIVATE_BUILD_DESC="espressowifixx-user 4.4.2 KOT49H P3110XWALD2 release-keys"