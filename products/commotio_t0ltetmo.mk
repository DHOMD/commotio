...
PRODUCT_NAME := commotio_t0ltetmo
PRODUCT_DEVICE := t0ltetmo
PRODUCT_BRAND := Samsung
PRODUCT_MANUFACTURER := Samsung
PRODUCT_MODEL := SCH-T889

PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=t0ltetmo BUILD_FINGERPRINT="samsung/t0ltetmo/t0ltetmo:4.4.2/KOT49H/937116:user/release-keys" PRIVATE_BUILD_DESC="t0ltetmo-user 4.4.2 KOT49H 937116 release-keys"
