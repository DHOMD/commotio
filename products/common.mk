...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.modversion=Commotio-B89 \
    ro.goo.version=89

# Version information used on all builds
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_DISPLAY_ID=LMY48G BUILD_ID=LMY48G BUILD_VERSION_TAGS=release-keys USER=android-build BUILD_EST_DATE=$(shell date +"%s")
