...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=razor TARGET_DEVICE=deb BUILD_FINGERPRINT=google/razor/deb:4.4.4/KTU84P/937116:user/release-keys PRIVATE_BUILD_DESC="razor-user 4.4.4 KTU84P 937116 release-keys"
