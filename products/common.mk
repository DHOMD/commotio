...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.modversion=Commotio-B90 \
    ro.goo.version=90

# Version information used on all builds
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_DISPLAY_ID=LMY48P BUILD_ID=LMY48P BUILD_VERSION_TAGS=release-keys USER=android-build BUILD_EST_DATE=$(shell date +"%s")
