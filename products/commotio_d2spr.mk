...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=d2spr TARGET_DEVICE=d2spr BUILD_FINGERPRINT="samsung/d2spr/d2spr:4.4.2/KOT49H/L710VPBMD4:user/release-keys" PRIVATE_BUILD_DESC="d2spr-user 4.4.2 KOT49H L710VPBMD4 release-keys"
