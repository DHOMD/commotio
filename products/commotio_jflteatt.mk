...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=jflteuc TARGET_DEVICE=jflteatt BUILD_FINGERPRINT="samsung/jflteuc/jflteatt:4.4.1/KOT49H/I337UCUAMDL:user/release-keys" PRIVATE_BUILD_DESC="jflteuc-user 4.4.1 KOT49H I337UCUAMDL release-keys"
