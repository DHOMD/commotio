...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=yakju BUILD_FINGERPRINT="google/yakju/maguro:4.4.4/KTU84P/937116:user/release-keys" PRIVATE_BUILD_DESC="yakju-user 4.4.4 KTU84P 937116 release-keys"
