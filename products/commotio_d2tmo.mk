...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=d2uc TARGET_DEVICE=d2tmo BUILD_FINGERPRINT="samsung/d2uc/d2att:4.4.1/KOT49H/T999UVDMD5:user/release-keys" PRIVATE_BUILD_DESC="d2uc-user 4.4.1 KOT49H T999UVDMD5 release-keys"
